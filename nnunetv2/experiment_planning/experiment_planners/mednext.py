...
from .residual_unets.residual_encoder_unet_planners import nnUNetPlannerResEncL
from nnunetv2.MedNeXT import MedNeXT

import torch


class MedNextPlanner(nnUNetPlannerResEncL):

    def __init__(
            self,
            dataset_name_or_id,
            gpu_memory_target_in_gb = 64,
            preprocessor_name = 'DefaultPreprocessor', 
            plans_name = 'MedNextPlanner', 
        ...
        self.UNet_blocks_per_stage_encoder = self.UNet_blocks_per_stage_decoder = (2, ) * 20
    ...
    def get_plans_for_configuration(self,
        ...
        architecture_kwargs = {
            ...
            'arch_kwargs': {
                ...
                'expansion_ratio_per_stage': [2] * (2 * num_stages - 1),
