...
class ExperimentPlanner(object):
    ...
    def determine_fullres_target_spacing(self) -> np.ndarray:
        ...
        sizes = self.dataset_fingerprint['shapes_after_cropping']
    ...
    def plan_experiment(self):
        ...
        new_shapes = [compute_new_shape(j, i, fullres_spacing) for i, j in
                      zip(self.dataset_fingerprint['spacings'], self.dataset_fingerprint['shapes_after_cropping'])]
        ...
        median_shape = np.median(self.dataset_fingerprint['shapes_after_cropping'], 0)[transpose_forward]
